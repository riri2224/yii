...
<header id="header">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ['label' => 'counts', 'url' => ['/counts/index']],
            ['label' => 'faq', 'url' => ['/faq/index']],
            ['label' => 'delivery', 'url' => ['/delivery/index']],
            ['label' => 'action', 'url' => ['/action/index']],
            ['label' => 'feature', 'url' => ['/feature/index']],
            ['label' => 'review', 'url' => ['/review/index']],
            ['label' => 'service', 'url' => ['/service/index']],
            ['label' => 'aboutus', 'url' => ['/aboutus/index']],
            ['label' => 'contactus', 'url' => ['/contactus/index']],
            ['label' => 'team', 'url' => ['/team/index']],
            ['label' => 'quote', 'url' => ['/quote/index']],
